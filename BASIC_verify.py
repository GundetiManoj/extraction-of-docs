...
import os
def draw_boxes_on_pdf(input_pdf_path, enriched_json_path, output_folder=r"ITR\BASIC\PAN\images"):
    # Load data
    ...
    for page_num in range(len(doc)):
        ...
        out_path = os.path.join(output_folder, f"pan_{page_num + 1}.png")
        img.save(out_path)
...
if __name__ == "__main__":
    input_pdf = r"ITR DOC\BASIC\PAN.pdf"
    enriched_json = r"ITR\BASIC\PAN\json\pan.json"
